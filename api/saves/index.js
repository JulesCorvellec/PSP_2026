...
import { requireMethod, withErrors, readJsonBody } from '../_lib/http.js';
...
async function handler(req, res) {
  ...
  // Une sauvegarde peut embarquer un import complet (jusqu'à plusieurs dizaines de Mo une fois
  // sérialisé) : lu via readJsonBody, qui décompresse un corps gzip si le frontend en a envoyé un pour
  // rester sous la limite de taille de requête de la plateforme (cf. api/_lib/http.js, index.html#apiFetch).
